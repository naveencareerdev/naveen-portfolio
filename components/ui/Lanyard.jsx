...
function Band({ isMobile, frontImage, backImage, imageFit, lanyardImage, lanyardWidth, cardScale }) {
  ...
  return (
    <>
      ...
      <mesh ref={band}><meshLineGeometry /><meshLineMaterial color="#4FBEA6" depthTest={false} resolution={isMobile ? [1000, 2000] : [1000, 1000]} useMap map={texture} repeat={[-4, 1]} lineWidth={lanyardWidth} /></mesh>
    </>
  );
}
